...
var e=getTop(),d=e.S(b.domid+"tipcontainer",b.win||b.doc),c=new (e.qmAnimation)({from:1,to:100});
c.play({speed:"slow",onaction:function(g,f){
e.setOpacity(d,Math.abs((a?0:-1)+f));
...
e.removeSelf(e.S(b.domid+"rlt",b.win));
}
}});
};
...
var d=(p[3]-n[3])-a.left,b=d+(a.arrow_offset||0);
...
var k=d.body,l={domid:p,doc:d,type:2,msg:'<div class="addrtitle">\u5907\u6CE8\u4FE1\u606F\uFF1A</div>'+e,arrowOffset:10,icon:"tipsico_note",images_path:o.getPath("image")},m=o.S(q,d);
o.removeSelf(m);
